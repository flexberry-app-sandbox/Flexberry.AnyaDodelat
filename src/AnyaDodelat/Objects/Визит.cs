...
namespace IIS.AnyaDodelat
{
    ...
    [View("ВизитE", new string[] {
            ...
            "Стоимость as \'Стоимость\'"}, Hidden=new string[] {
            "Клиент.ФИО"})]
    ...
    public class Визит : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.AnyaDodelat.Клиент fКлиент;
        
        private IIS.AnyaDodelat.DetailArrayOfЗаписьВизита fЗаписьВизита;
        ...
        /// Стоимость.
        /// </summary>
        // *** Start programmer edit section *** (Визит.Стоимость CustomAttributes)

        // *** End programmer edit section *** (Визит.Стоимость CustomAttributes)
        public virtual double Стоимость
        {
            get
            {
                // *** Start programmer edit section *** (Визит.Стоимость Get start)

                // *** End programmer edit section *** (Визит.Стоимость Get start)
                double result = this.fСтоимость;
                // *** Start programmer edit section *** (Визит.Стоимость Get end)

                // *** End programmer edit section *** (Визит.Стоимость Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Визит.Стоимость Set start)

                // *** End programmer edit section *** (Визит.Стоимость Set start)
                this.fСтоимость = value;
                // *** Start programmer edit section *** (Визит.Стоимость Set end)

                // *** End programmer edit section *** (Визит.Стоимость Set end)
            }
        }
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.AnyaDodelat.Клиент Клиент
        {
            get
            {
                ...
                IIS.AnyaDodelat.Клиент result = this.fКлиент;
        ...
        public virtual IIS.AnyaDodelat.DetailArrayOfЗаписьВизита ЗаписьВизита
        {
            get
            {
                ...
                {
                    this.fЗаписьВизита = new IIS.AnyaDodelat.DetailArrayOfЗаписьВизита(this);
                }
                IIS.AnyaDodelat.DetailArrayOfЗаписьВизита result = this.fЗаписьВизита;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ВизитE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВизитE", typeof(IIS.AnyaDodelat.Визит));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ВизитL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВизитL", typeof(IIS.AnyaDodelat.Визит));
                }
            }
        }
    }
