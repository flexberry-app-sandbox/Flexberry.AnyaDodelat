...
namespace IIS.AnyaDodelat
{
    ...
    public class СоставУслуги : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.AnyaDodelat.Единицы fЕдиницы;
        
        private IIS.AnyaDodelat.Товар fТовар;
        ...
        public virtual IIS.AnyaDodelat.Единицы Единицы
        {
            get
            {
                ...
                IIS.AnyaDodelat.Единицы result = this.fЕдиницы;
        ...
        [PropertyStorage(new string[] {
                "Товар"})]
        [NotNull()]
        public virtual IIS.AnyaDodelat.Товар Товар
        {
            get
            {
                ...
                IIS.AnyaDodelat.Товар result = this.fТовар;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.AnyaDodelat.Услуга.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СоставУслугиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СоставУслугиE", typeof(IIS.AnyaDodelat.СоставУслуги));
                }
            }
        }
    }
    ...
    public class DetailArrayOfСоставУслуги : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.AnyaDodelat.DetailArrayOfСоставУслуги members)

        // *** End programmer edit section *** (IIS.AnyaDodelat.DetailArrayOfСоставУслуги members)
        ...
        /// </summary>
        public DetailArrayOfСоставУслуги(IIS.AnyaDodelat.Услуга fУслуга) : 
                base(typeof(СоставУслуги), ((ICSSoft.STORMNET.DataObject)(fУслуга)))
        {
        }
        
        public IIS.AnyaDodelat.СоставУслуги this[int index]
        {
            get
            {
                return ((IIS.AnyaDodelat.СоставУслуги)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.AnyaDodelat.СоставУслуги dataobject)
        {
