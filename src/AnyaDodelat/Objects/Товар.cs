...
namespace IIS.AnyaDodelat
{
    ...
    public class Товар : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.AnyaDodelat.Производитель fПроизводитель;
        ...
        [PropertyStorage(new string[] {
                "Производитель"})]
        [NotNull()]
        public virtual IIS.AnyaDodelat.Производитель Производитель
        {
            get
            {
                ...
                IIS.AnyaDodelat.Производитель result = this.fПроизводитель;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварE", typeof(IIS.AnyaDodelat.Товар));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТоварL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварL", typeof(IIS.AnyaDodelat.Товар));
                }
            }
        }
    }
