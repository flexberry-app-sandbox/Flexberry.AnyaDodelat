...
namespace IIS.AnyaDodelat
{
    ...
    [View("УслугаE", new string[] {
            ...
            "Цена as \'Цена\'",
            "ДлительностьМин as \'Длительность мин\'"})]
    ...
    public class Услуга : ICSSoft.STORMNET.DataObject
    {
        ...
        private int fДлительностьМин;
        
        private IIS.AnyaDodelat.DetailArrayOfСоставУслуги fСоставУслуги;
        ...
        /// ДлительностьМин.
        /// </summary>
        // *** Start programmer edit section *** (Услуга.ДлительностьМин CustomAttributes)

        // *** End programmer edit section *** (Услуга.ДлительностьМин CustomAttributes)
        public virtual int ДлительностьМин
        {
            get
            {
                // *** Start programmer edit section *** (Услуга.ДлительностьМин Get start)

                // *** End programmer edit section *** (Услуга.ДлительностьМин Get start)
                int result = this.fДлительностьМин;
                // *** Start programmer edit section *** (Услуга.ДлительностьМин Get end)

                // *** End programmer edit section *** (Услуга.ДлительностьМин Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Услуга.ДлительностьМин Set start)

                // *** End programmer edit section *** (Услуга.ДлительностьМин Set start)
                this.fДлительностьМин = value;
                // *** Start programmer edit section *** (Услуга.ДлительностьМин Set end)

                // *** End programmer edit section *** (Услуга.ДлительностьМин Set end)
            }
        }
        ...
        public virtual IIS.AnyaDodelat.DetailArrayOfСоставУслуги СоставУслуги
        {
            get
            {
                ...
                {
                    this.fСоставУслуги = new IIS.AnyaDodelat.DetailArrayOfСоставУслуги(this);
                }
                IIS.AnyaDodelat.DetailArrayOfСоставУслуги result = this.fСоставУслуги;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View УслугаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугаE", typeof(IIS.AnyaDodelat.Услуга));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УслугаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугаL", typeof(IIS.AnyaDodelat.Услуга));
                }
            }
        }
    }
