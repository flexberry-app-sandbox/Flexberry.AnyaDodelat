...
namespace IIS.AnyaDodelat
{
    ...
    public class сотрудник : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.AnyaDodelat.Пол fПол;
        
        private IIS.AnyaDodelat.Должности fДолжности;
        
        private IIS.AnyaDodelat.DetailArrayOfУслугиМастера fУслугиМастера;
        ...
        public virtual IIS.AnyaDodelat.Пол Пол
        {
            get
            {
                ...
                IIS.AnyaDodelat.Пол result = this.fПол;
        ...
        [PropertyStorage(new string[] {
                "Должности"})]
        [NotNull()]
        public virtual IIS.AnyaDodelat.Должности Должности
        {
            get
            {
                ...
                IIS.AnyaDodelat.Должности result = this.fДолжности;
        ...
        public virtual IIS.AnyaDodelat.DetailArrayOfУслугиМастера УслугиМастера
        {
            get
            {
                ...
                {
                    this.fУслугиМастера = new IIS.AnyaDodelat.DetailArrayOfУслугиМастера(this);
                }
                IIS.AnyaDodelat.DetailArrayOfУслугиМастера result = this.fУслугиМастера;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View сотрудникE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("сотрудникE", typeof(IIS.AnyaDodelat.сотрудник));
                }
            }
            ...
            public static ICSSoft.STORMNET.View сотрудникL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("сотрудникL", typeof(IIS.AnyaDodelat.сотрудник));
                }
            }
        }
    }
