...
CREATE TABLE ТабельСмены (
 primaryKey UUID NOT NULL,
 Дата TIMESTAMP(3) NULL,
 КонецСмены VARCHAR(255) NULL,
 НачалоСмены VARCHAR(255) NULL,
 типЗанятости VARCHAR(8) NULL,
 сотрудник UUID NOT NULL,
 PRIMARY KEY (primaryKey));
...
CREATE TABLE ApplicationLog (
 ...
 ALTER TABLE ГрафикРаботы ADD CONSTRAINT FK39585d336f4dbc2068c9a2ec23559956365dc34f FOREIGN KEY (сотрудник) REFERENCES сотрудник; 
CREATE INDEX Index39585d336f4dbc2068c9a2ec23559956365dc34f on ГрафикРаботы (сотрудник); 
...
CREATE INDEX Indexb1fd474dfc33f87612c15318bb5df8dc5bc6cecb on УслугиМастера (сотрудник); 
 ...
 ALTER TABLE ТабельСмены ADD CONSTRAINT FK95d8f23ec8cf4da9ad5e8722e3ed53b8b7a67142 FOREIGN KEY (сотрудник) REFERENCES сотрудник; 
CREATE INDEX Index95d8f23ec8cf4da9ad5e8722e3ed53b8b7a67142 on ТабельСмены (сотрудник); 

 ALTER TABLE Отсутствие ADD CONSTRAINT FKcb285de900d0be0fd772c3e8cbf153630bc5b427 FOREIGN KEY (сотрудник) REFERENCES сотрудник; 
CREATE INDEX Indexcb285de900d0be0fd772c3e8cbf153630bc5b427 on Отсутствие (сотрудник); 
